...
void Reconstruction::DonorCellX1(MeshBlock *pmb, const int kl, const int ku, const int jl,
...
void Reconstruction::DonorCellX2(MeshBlock *pmb, const int kl, const int ku, const int jl,
                                 const int ju, const int il, const int iu,
                                 const AthenaArray<Real> &w, const AthenaArray<Real> &bcc,
                                 AthenaArray<Real> &wl, AthenaArray<Real> &wr) {
  // compute L/R states for each variable
...
void Reconstruction::DonorCellX3(MeshBlock *pmb, const int kl, const int ku, const int jl,
                                 const int ju, const int il, const int iu,
                                 const AthenaArray<Real> &w, const AthenaArray<Real> &bcc,
                                 AthenaArray<Real> &wl, AthenaArray<Real> &wr) {
  // compute L/R states for each variable
