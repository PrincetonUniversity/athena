...
void OutflowInnerX1(MeshBlock *pmb, Coordinates *pco, FaceField &a,
...
void OutflowOuterX1(MeshBlock *pmb, Coordinates *pco, FaceField &a,
                    int is, int ie, int js, int je, int ks, int ke)
{
  for (int k=ks; k<=ke; ++k) {
  for (int j=js; j<=je; ++j) {
...
void OutflowInnerX2(MeshBlock *pmb, Coordinates *pco, FaceField &a,
                    int is, int ie, int js, int je, int ks, int ke)
{
  for (int k=ks; k<=ke; ++k) {
...
void OutflowOuterX2(MeshBlock *pmb, Coordinates *pco, FaceField &a,
                    int is, int ie, int js, int je, int ks, int ke)
{
  for (int k=ks; k<=ke; ++k) {
  for (int j=1; j<=(NGHOST); ++j) {
...
void OutflowInnerX3(MeshBlock *pmb, Coordinates *pco, FaceField &a,
                    int is, int ie, int js, int je, int ks, int ke)
{
...
void OutflowOuterX3(MeshBlock *pmb, Coordinates *pco, FaceField &a,
                    int is, int ie, int js, int je, int ks, int ke)
{
  for (int k=1; k<=(NGHOST); ++k) {
  for (int j=js; j<=je; ++j) {
