  ...
  for (int k=kl; k<=ku; ++k) {
    for (int j=jl; j<=ju; ++j) {
      ...
      if (order == 1) {
        ...
        pmb->precon->WenoThirdX1(k, j, is-1, ie+1, r, rl_, rr_);
      } else if (order == 5) {
        pmb->precon->WenoFifthX1(k, j, is-1, ie+1, r, rl_, rr_);
      } else {
  ...
  if (pmb->pmy_mesh->f2) {
    ...
    for (int k=kl; k<=ku; ++k) {
      ...
      if (order == 1) {
        ...
        pmb->precon->WenoThirdX2(k, js-1, il, iu, r, rl_, rr_);
      } else if (order == 5) {
        pmb->precon->WenoFifthX2(k, js-1, il, iu, r, rl_, rr_);
      } else {
...
#pragma omp simd
      ...
      for (int j=js; j<=je+1; ++j) {
        ...
        if (order == 1) {
          ...
          pmb->precon->WenoThirdX2(k, j, il, iu, r, rlb_, rr_);
        } else if (order == 5) {
          pmb->precon->WenoFifthX2(k, j, il, iu, r, rlb_, rr_);
        } else {
  ...
  if (pmb->pmy_mesh->f3) {
    ...
    for (int j=jl; j<=ju; ++j) { // this loop ordering is intentional
      ...
      if (order == 1) {
        ...
        pmb->precon->WenoThirdX3(ks-1, j, il, iu, r, rl_, rr_);
      } else if (order == 5) {
        pmb->precon->WenoFifthX3(ks-1, j, il, iu, r, rl_, rr_);
      } else {
...
#pragma omp simd
      ...
      for (int k=ks; k<=ke+1; ++k) {
        ...
        if (order == 1) {
          ...
          pmb->precon->WenoThirdX3(k, j, il, iu, r, rlb_, rr_);
        } else if (order == 5) {
          pmb->precon->WenoFifthX3(k, j, il, iu, r, rlb_, rr_);
        } else {
