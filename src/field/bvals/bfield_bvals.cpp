...
//======================================================================================
/*! \file bfield_bvals.cpp
 *  \brief implements functions that initialize/apply BField BCs on each edge
 *====================================================================================*/

// BFieldBoundaryConditions constructor - sets function pointers for the appropriate
// bfield boundary conditions at each of the 6 edges of a MeshBlock

BFieldBoundaryConditions::BFieldBoundaryConditions(Fluid *pf, ParameterInput *pin)
{
  pmy_fluid = pf;
...
void BFieldBoundaryConditions::ApplyBoundaryConditions(AthenaArray<Real> &a)
{
