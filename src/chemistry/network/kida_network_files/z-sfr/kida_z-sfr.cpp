...
//========================================================================================
//! \file kida_z-sfr.cpp
//! \brief implementation of special rates in z-sfr network in kida format
//!   This is the network used in the Z-SFR relation paper
//!   (TODO(Gong): need to add citation)
...
void ChemNetwork::UpdateRatesSpecial(const Real y[NSCALARS], const Real E) {
  ...
  //(51) H2 + CR -> H+ + H-
  kcr_(id7map_(51)) = 6e-4 * kcr_H_fac * rad_(index_cr_);
