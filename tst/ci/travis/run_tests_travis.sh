...
python3 run_tests.py amr --config=--cxx=$TEMP_CXX
# mhd/ contains the longest set of tests. Timeout after 10 m on Travis CI
# python3 run_tests.py mhd
python3 run_tests.py hydro --config=--cxx=$TEMP_CXX
python3 run_tests.py outputs --config=--cxx=$TEMP_CXX
python3 run_tests.py curvilinear --config=--cxx=$TEMP_CXX
python3 run_tests.py gr --config=--cxx=$TEMP_CXX
python3 run_tests.py sr --config=--cxx=$TEMP_CXX
python3 run_tests.py shearingbox --config=--cxx=$TEMP_CXX
python3 run_tests.py diffusion --config=--cxx=$TEMP_CXX
