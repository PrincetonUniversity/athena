...
def MakeRhoVSlice(data_cart, vx_cart, vy_cart, minval, maxval, vlim1, vlim2, width, xmin, xmax, ymin, ymax,xgrid,ygrid,label1,label2,time,outputname,vel=0):
    ...
    axes.set_xticks([-6.,-4.0, -2., 0., 2.,4.,6.0])
...
def makemovies(ni,no,minval,maxval,vlim1,vlim2,width=40,res=4,vel=0,var1='density',var2='vel1',var3='vel3',label1='$\\rho/\\rho_0$',label2='$v/c$'):
...
for i in range(ni,no+1,nprocs):
  ...
  print fi, rank
  makemovies(fi,fi,rhomin,rhomax,1.e-5,1.0,width=6,vel=1)
  makemovies(fi,fi,Ermin,Ermax,1.e-3,10.0,width=6,vel=1,var1='Er',var2='B1',var3='B2',label1='$E_r/a_rT_0^4$',label2='B')
